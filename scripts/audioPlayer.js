...
function handleProgress() {
  ...
  audioProgress.style.background = `linear-gradient(to right, #0bdbac 0%, #0bdbac ${percent}%, #fff ${percent}%)`;
...
function setProgress() {
  ...
  audioProgress.style.background = `linear-gradient(to right, #0bdbac 0%, #0bdbac ${audioProgress.value}%, #fff ${audioProgress.value}%)`;
  displayReadableTime(currentTime);
}
...
function handleProgressVolume(volumeValue) {
  ...
  volumeProgress.style.background = `linear-gradient(to right, #0bdbac 0%, #0bdbac ${percent}%, #fff ${percent}%)`;
